        ...
        upload.render({
            ...
            , done: function (res) {
                ...
                if (res.code == 200) {
                    ...
                    var pageTemp = config.page;
                    // console.log("tableIns:"+JSON.stringify(tableIns));
                    // console.log("config:"+JSON.stringify(config));
                    // console.log("pageTemp:"+JSON.stringify(pageTemp));
                    // 用新的总条数除以limit向上取整得到新的页数
                    var currTemp = Math.ceil((pageTemp.count + res.data) / pageTemp.limit);

                    tableIns = table.reload('user-id', {
                        page: {
                            curr: currTemp || 1
                        }
                    });
